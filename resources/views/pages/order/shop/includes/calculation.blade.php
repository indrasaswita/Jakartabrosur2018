	...
	<div class="panel-block">
		...
		<div class="block-list" ng-repeat="item in datas.jobsubtypefinishing">
			...
			<div class="input">
				...
				<div class="warning-message" ng-if="selected.finishings[$index].warningmessage!=null">
					<small class="fas fa-exclamation-triangle fa-fw tx-warning"></small> Warning:
					[[(selected.finishings[$index].warningmessage)]]
				</div>
			</div>
		</div>
