...
<script async type="text/javascript" src="{{URL::asset('js/popper.min.js')}}?version=1.16.0"></script>
<script async type="text/javascript" src="{{URL::asset('js/bootstrap.js')}}?version=4.4.1"></script>
<script async type="text/javascript" src="{{URL::asset('js/bootstrap-select.min.js')}}?version=4.4.1"></script>
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-7736580917864332",
