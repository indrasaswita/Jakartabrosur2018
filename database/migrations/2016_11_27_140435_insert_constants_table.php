...
class InsertConstantsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('constants')->insert(['name'=>'BiayaPlatSM52', 'price'=>'25000']);
        DB::table('constants')->insert(['name'=>'BiayaPlatSM74', 'price'=>'125000']);
        DB::table('constants')->insert(['name'=>'BiayaPlatSM102', 'price'=>'175000']);
        DB::table('constants')->insert(['name'=>'BiayaPlatSM105', 'price'=>'175000']);
        DB::table('constants')->insert(['name'=>'InschietSM52', 'price'=>'150']);
        DB::table('constants')->insert(['name'=>'InschietSM74', 'price'=>'200']);
        DB::table('constants')->insert(['name'=>'InschietSM102', 'price'=>'300']);
        DB::table('constants')->insert(['name'=>'InschietSM105', 'price'=>'300']);
        ...
        DB::table('constants')->insert(['name'=>'OngkosCetakSisaSM52', 'price'=>'22']);
        ...
        DB::table('constants')->insert(['name'=>'OngkosCetakMinimSM52', 'price'=>'80000']);
        DB::table('constants')->insert(['name'=>'OngkosCetakMinimSM74', 'price'=>'150000']);
        DB::table('constants')->insert(['name'=>'OngkosCetakMinimSM102', 'price'=>'400000']);
        DB::table('constants')->insert(['name'=>'OngkosCetakMinimSM105', 'price'=>'410000']);
