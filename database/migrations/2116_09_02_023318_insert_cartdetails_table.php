...
class InsertCartdetailsTable extends Migration
{
	...
	public function up()
	{
		DB::unprepared("
			...
			INSERT INTO cartdetails values('5','4','Main','DG','5','5','1','2','30.5','44','29.2','41','4','4','susun anom, lipet anom bacok, jilid staples','2700','200','675','4','2','2','0','1','1','1','0','400000',now(),now());
		");
	}
